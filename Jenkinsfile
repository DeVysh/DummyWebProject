node('LinuxSlave') {
   echo 'Hello World'
   ansiblePlaybook forks: 5, installation: 'Ansible', inventory: '/etc/ansible/hosts', playbook: '/var/lib/jenkins/jobs/windows_helloworld.yml', sudo: true, sudoUser: 'e	c2-user'
