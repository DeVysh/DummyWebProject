...
node('LinuxSlave') {
   ...
   ansiblePlaybook extras: 'envType=DEV' forks: 5, installation: 'Ansible', inventory: '/etc/ansible/hosts', playbook: '/home/ec2-user/Release/cloudStack_SingleInstance.yml'
